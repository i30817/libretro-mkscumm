**THIS PROGRAM IS OUTDATED BECAUSE THE SCUMMVM CORE GOT THIS FUNCTIONALITY IF YOU START THE CORE IN RETROARCH, ADD GAMES AND CHECK THE GLOBAL OPTIONS BACKEND TAB**
